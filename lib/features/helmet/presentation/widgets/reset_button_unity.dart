...
class ResetButtonUnity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return unityWidgetController == null? const SizedBox() : Align(
      alignment: Alignment.topCenter,
      child: Padding(
        padding: const EdgeInsets.only(top: 16),
        child: AppButtonTextUnity(text: 'Reset', width: 96, onTap: () {
          unityWidgetController?.postMessage('CanvasEventManager', 'CallEventButtonResetClick', 'test');
        }),
      ),
    );
  }
